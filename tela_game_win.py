...
class TelaVitoria:
    def __init__(self):
        ...
        # Cores
        self.cor_fundo = ('#a2c8a5')  # Vermelho claro
    ...
    def desenhar(self, tela):
        ...
        # Título "VOCÊ PERDEU"
        titulo = self.fonte_titulo.render("PARABÉNS!", True, self.cor_titulo)
        titulo_rect = titulo.get_rect(center=(LARGURA_TELA//2, 150))
        
        # Efeito de sombra no título
        titulo_sombra = self.fonte_titulo.render("PARABÉNS!", True, (self.cor_fundo))
        tela.blit(titulo_sombra, (titulo_rect.x + 3, titulo_rect.y + 3))
        tela.blit(titulo, titulo_rect)
        
        # Mensagem "VOLTE AO MENU E TENTE NOVAMENTE!"
        mensagem1 = self.fonte_mensagem.render("VOCÊ GANHOU! ", True, self.cor_mensagem)
        mensagem1_rect = mensagem1.get_rect(center=(LARGURA_TELA//2, 270))
